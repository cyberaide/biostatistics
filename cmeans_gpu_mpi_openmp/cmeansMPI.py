...
def usage():
    print "Usage: ./cmeansMPI.py INPUT_FILE NUM_CLUSTERS [THRESHOLD=0.0001] [MIN_ITERS=0] [MAX_ITERS=100] [DEVICE=0] [FUZZINESS=2] [DISTANCE_MEASURE=0] [K1=1.0] [K2=0.01] [K3=1.5] [MEMBER_THRESHOLD=0.05] [TABU_ITER=100] [TABU_TENURE=5] [MDL=0] [CPU_ONLY=0] [NP=2]"
    print
...
if __name__ == '__main__':
    ...
    header_file = open("cmeansMPI.in.h",'r').read()
    new_header = open("cmeansMPI.h",'w')
