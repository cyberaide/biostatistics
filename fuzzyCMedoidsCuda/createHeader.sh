...
perl -pi -e "s/#define THREAD_DATA_SIZE VALUE/#define THREAD_DATA_SIZE $THREAD_DATA_SIZE/g" cmedoids.h
perl -pi -e "s/#define THREAD_DATA_SIZE_LAST VALUE/#define THREAD_DATA_SIZE_LAST $THREAD_DATA_SIZE_LAST/g" cmedoids.h
